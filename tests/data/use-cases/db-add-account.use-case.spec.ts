...
import { AddAccountUseCaseError } from '@/data/use-cases/account/add-account/errors'
import { AddAccountOutput } from '@/domain/use-cases/account/add-account'
import {
  createAddAccountRepositoryStub,
  createHasherStub,
  createLoadAccountByEmailRepositoryStub,
} from '../mocks'
import { DbAddAccountUseCase } from '@/data/use-cases/account/add-account'
import {
  fakeAccount,
  fakeAccountInput,
...
} from '@/data/use-cases/authentication'
